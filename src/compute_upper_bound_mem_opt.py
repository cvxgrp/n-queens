...
from solvers.newton_inv_hess import InvHessianAffineCvxProblem

import problem_formulations.approximate_xqueenons as approximate_xqueenons
import problem_formulations.xqueenons_w_inv_hessian as xqueenons
...
if __name__ == '__main__':
    ...
    f, df, invd2f = xqueenons.construct_objective_fxn_derivs(n)
    ...
    initial_time = time.monotonic()
    x, v, norm_r, iters = InvHessianAffineCvxProblem(A, b, f, df, invd2f, 0, initial_point=x_init).solve()
    final_time = time.monotonic()
